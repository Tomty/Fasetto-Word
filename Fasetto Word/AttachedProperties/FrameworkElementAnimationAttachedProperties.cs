...
namespace Fasetto_Word
{
        ...
        where Parent : BaseAttachedProperty<Parent, bool>, new()
    {
        ...
        public override void OnValueUpdated(DependencyObject sender, object value)
        {
            ...
            if(FirstLoad)
            {
                // Create a singel self-unhookable event
    ...
    /// <summary>
    /// Animate a framework element sliding it in from the left on show and sliding out to the left on hide
    /// </summary>
    ...
    /// <summary>
    /// Animate a framework element sliding it up from the bottom on show and sliding out to the bottom on hide
    /// </summary>
